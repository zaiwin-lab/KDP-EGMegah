  ...
  partners: [
    {
      ...
      role: 'Pemaju perumahan — design and build',
      registration: '202301040913 (1534832-V)',
      established: 'Established 2023',
      address: 'Sublot 13, Matang Parade, Jalan Matang, 93050 Kuching, Sarawak',
      phone: '011-1010 5885',
      email: 'hello@egmegah.com',
      website: 'https://www.egmegah.com',
      credentials: [
        'Building materials certified by SIRIM, Jabatan Bomba and CIDB',
        'Audited against SMETA ethical trade standards',
        'Member, Persatuan Kontraktor Perumahan Malaysia (PKPM) — Sarawak',
        'Proprietary cast in-situ aircrete wall and modular formwork system',
      ],
      responsibilities: [
...
export const PAYMENT_STAGES: PaymentStage[] = [
  {
    ...
    percentage: 15, amount: 36450, status: 'paid',
  ...
  },
  {
    ...
    percentage: 30, amount: 72900, status: 'awaiting_authorisation',
  ...
  },
  {
    ...
    percentage: 35, amount: 85050, status: 'not_due',
  },
  {
    ...
    percentage: 20, amount: 48600, status: 'not_due',
  },
];
...
export const NOTIFICATIONS: Notification[] = [
  ...
  { id: 'nt_4', org_id: ORG_ID, profile_id: PROFILE.id, created_at: '2026-04-25T16:35:00+08:00', title: 'Release 1 has been paid', body: 'KPSM has recorded payment of RM 36,450 to EGMH for mobilisation and contract commencement.', channel: 'payment', read: true, link: '/app/payments' },
];
...
export const AUDIT: AuditRecord[] = [
  ...
  { id: 'au_8', org_id: ORG_ID, at: '2026-08-27T10:12:00+08:00', actor_name: 'Sim Chee Hong', actor_role: 'egmh', action: 'Payment claim submitted', entity: 'payment_stage', entity_ref: 'CLM-0417-02', detail: 'Release 2 claimed for RM 72,900 with structural completion evidence attached.', human_authorised: true },
  ...
  { id: 'au_6', org_id: ORG_ID, at: '2026-04-25T16:30:00+08:00', actor_name: 'KPSM finance', actor_role: 'kpsm', action: 'Payment recorded', entity: 'payment_stage', entity_ref: 'CLM-0417-01', detail: 'RM 36,450 paid to EGMH. Reference KPSM/TT/26/00812.', human_authorised: true },
